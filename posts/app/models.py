...
class Love(models.Model):
    comment = models.ForeignKey(Comment, on_delete=models.CASCADE, related_name='comment_love')
    creator = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_love')
...
class Reply(CommentBase):
    ...
    creator = models.ForeignKey(User, on_delete=models.CASCADE, related_name='user_reply', default=1)
